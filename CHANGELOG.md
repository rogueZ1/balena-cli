...
* errors: Remove BalenaAmbiguousDevice error message [Marios Balamatsias]
* deactivate: Remove yes flag casting [Marios Balamatsias]
* common-flags: Add default false on yes flag [Marios Balamatsias]
